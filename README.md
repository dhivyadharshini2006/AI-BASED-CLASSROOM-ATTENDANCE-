...
```bash
git clone https://github.com/YourUsername/ai-face-recognition-attendance.git
...
**Step 2: The Face Recognition Engine (The "AI" Core)**
  ...
  * The `face_recognition` library works in two phases:
    1.  **Enrollment:** You show it pictures of known students and it creates a "face encoding" (a 128-number vector) for each.
    2.  **Recognition:** You show it a new face, it creates a new encoding, and it compares this new encoding to all the known ones to find the closest match.
